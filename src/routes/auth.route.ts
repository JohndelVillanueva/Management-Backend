...
import { signupController, logoutController , loginController,resendVerification,forgotPassword, verifyEmailController } from '../controllers/auth/auth_controller.js';
